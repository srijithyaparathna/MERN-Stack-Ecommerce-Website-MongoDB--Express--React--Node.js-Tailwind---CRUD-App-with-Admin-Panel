    ...
    <section className="max_padd_container py-12 xl:py-28">
      <div>
        ...
        <div className="flexBetween my-8 mx-2 ">
          ...
          <div className="flexBetween max-ms:p-4 gap-x-4 px-8 py-3 rounded-5xl ring-1 ring-slate-900/15 ">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
          {all_products.map((item) => {
            ...
            return null; // Return null if item doesn't match the category
          })}
        </div>
...
// Define prop types for Category component
Category.propTypes = {
  category: PropTypes.string.isRequired, // Validate category as a required string
  banner: PropTypes.string.isRequired,   // Validate banner as a required string
};
